...
import com.intuition.cicerone.notificazione.statonotificazione.EliminazioneGlobetrotter;

public class TestEliminazioneGlobetrotter {
	...
	@Before
	public void setUp() {
		toString = "Sei stato disicritto da";
		n = mock(INotificable.class);
		cmd = new EliminazioneGlobetrotter();
	}
